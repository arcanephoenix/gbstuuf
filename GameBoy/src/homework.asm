...
;Sprite L
_SPR4_Y		EQU			_OAMRAM+16	;y position
_SPR4_X		EQU			_OAMRAM+17	;x position
_SPR4_NUM	EQU			_OAMRAM+18	;tile number
_SPR4_ATT	EQU			_OAMRAM+19	;sprite atttributes
...
player0Xlhs		EQU		_RAM_BLOCK_0+5		;pix left of the player
player0Xrhs		EQU		_RAM_BLOCK_0+6		;pix right of the player
player0Yab		EQU		_RAM_BLOCK_0+7		;pix above player
player0Ybel		EQU		_RAM_BLOCK_0+8		;pix below player
...
Movement:
	...
	ld		a, [player0X]	; save player position
	dec		a
	ld 		[player0Xlhs],a ;
	add     10		;				; to find the pix right of the player, 1+8pix player+1 
	ld      [player0Xrhs],a
	ld		a,[player0Y]		
	add		32
	ld		[player0Ybel],a
...
MoveLeft:
	...
	cp		a, 32  ;if the PC is on the 32 line of the screen
	jp		z, .LeftScreen
.LeftPlayer:
	dec		a
	ld		[player0X], a
...
MoveRight:
	ld		a, [player0X]
	cp		a, 136 ;if the PC is on the 136 line, move the screen instead of player
	jp		z, .RightScreen
.RightPlayer:
	inc		a
	ld		[player0X], a
